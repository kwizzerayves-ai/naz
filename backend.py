    ...
    <style>
        ...
        *::before {
        ...
        .nazli-text {
            ...
            font-size: 12vmin;
            font-family: 'Segoe UI', 'Arial Black', 'Pacifico', cursive;
            font-weight: bold;
            background: linear-gradient(135deg, #ffb347, #ffcc33, #ff69b4, #fff);
            background-clip: text;
            -webkit-background-clip: text;
            color: transparent;
            text-shadow: 0 0 10px #ff69b4, 0 0 20px #ff1493, 0 0 40px #ff69b4;
            animation: nazliGlow 2s ease-in-out infinite, nazliFloat 3s ease-in-out infinite;
            z-index: 1000;
        ...
        @keyframes nazliGlow {
            0% { text-shadow: 0 0 5px #ff69b4, 0 0 10px #ff1493; opacity: 0.9; }
            50% { text-shadow: 0 0 20px #ff69b4, 0 0 40px #ff1493, 0 0 60px #ffcc33; opacity: 1; }
            100% { text-shadow: 0 0 5px #ff69b4, 0 0 10px #ff1493; opacity: 0.9; }
        }

        @keyframes nazliFloat {
        ...
        .flower__line {
            ...
            animation: grow-flower-tree 4s backwards, stemWind 2.5s ease-in-out infinite;
        }
        .flower__line__leaf {
            --w: 7vmin;
            --h: calc(var(--w) + 2vmin);
        ...
        @keyframes moving-flower-2 {
            0%, 100% { transform: rotate(22deg) translateX(0px); }
        ...
        @keyframes leafWind {
            ...
            50% { transform: translate(-48%, -2%) rotate(2deg); }
        }
        @keyframes stemWind {
